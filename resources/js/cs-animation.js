...
function csMove0() {
	...
	elem.addEventListener("mouseover", function( event ) {   
		document.getElementById("cs-folder0").src = "resources/images/home/folder-open.png";
	...
	elem.addEventListener("mouseout", function( event ) {   
		document.getElementById("cs-folder0").src = "resources/images/home/folder-closed.png";
...
function csMove1() {
	...
	// when mouse hovers over circle, it expands and stops
	elem.addEventListener("mouseover", function( event ) {   
		document.getElementById("cs-folder1").src = "resources/images/home/folder-open.png";
		elem.style.backgroundColor = backgroundColor1;
		elem.style.zIndex = "2";
		if (xpos > window.innerWidth / 2) {
			elem.children[2].style.left = tooltipRight;
	...
	// when mouse is stops hovering over circle, go back go original size && continue moving
	elem.addEventListener("mouseout", function( event ) {   
		document.getElementById("cs-folder1").src = "resources/images/home/folder-closed.png";
		elem.style.backgroundColor = backgroundColor0;
		elem.style.zIndex = "1";
		stop = false;
	}, false);
...
function csMove2() {
	...
	// when mouse hovers over circle, it expands and stops
	elem.addEventListener("mouseover", function( event ) {   
		document.getElementById("cs-folder2").src = "resources/images/home/folder-open.png";
		elem.style.backgroundColor = backgroundColor1;
		elem.style.zIndex = "2";
		if (xpos > window.innerWidth / 2) {
			elem.children[2].style.left = tooltipRight;
	...
	// when mouse is stops hovering over circle, go back go original size && continue moving
	elem.addEventListener("mouseout", function( event ) {   
		document.getElementById("cs-folder2").src = "resources/images/home/folder-closed.png";
		elem.style.backgroundColor = backgroundColor0;
		elem.style.zIndex = "1";		
		stop = false;
	}, false);
...
function csMove3() {
	...
	// when mouse hovers over circle, it expands and stops
	elem.addEventListener("mouseover", function( event ) {   
		document.getElementById("cs-folder3").src = "resources/images/home/folder-open.png";
		elem.style.backgroundColor = backgroundColor1;
		elem.style.zIndex = "2";
		if (xpos > window.innerWidth / 2) {
			elem.children[2].style.left = tooltipRight;
	...
	// when mouse is stops hovering over circle, go back go original size && continue moving
	elem.addEventListener("mouseout", function( event ) {   
		document.getElementById("cs-folder3").src = "resources/images/home/folder-closed.png";
		elem.style.backgroundColor = backgroundColor0;
		elem.style.zIndex = "1";
		stop = false;
	}, false);
...
function csMove4() {
	...
	// when mouse hovers over circle, it expands and stops
	elem.addEventListener("mouseover", function( event ) {   
		document.getElementById("cs-folder4").src = "resources/images/home/folder-open.png";
		elem.style.backgroundColor = backgroundColor1;
		elem.style.zIndex = "2";
		if (xpos > window.innerWidth / 2) {
			elem.children[2].style.left = tooltipRight;
	...
	// when mouse is stops hovering over circle, go back go original size && continue moving
	elem.addEventListener("mouseout", function( event ) {   
		document.getElementById("cs-folder4").src = "resources/images/home/folder-closed.png";
		elem.style.backgroundColor = backgroundColor0;
		elem.style.zIndex = "1";		
		stop = false;
	}, false);
...
function csMove5() {
	...
	// when mouse hovers over circle, it expands and stops
	elem.addEventListener("mouseover", function( event ) {   
		document.getElementById("cs-folder5").src = "resources/images/home/folder-open.png";
		elem.style.backgroundColor = backgroundColor1;
		elem.style.zIndex = "2";
		if (xpos > window.innerWidth / 2) {
			elem.children[2].style.left = tooltipRight;
	...
	// when mouse is stops hovering over circle, go back go original size && continue moving
	elem.addEventListener("mouseout", function( event ) {   
		document.getElementById("cs-folder5").src = "resources/images/home/folder-closed.png";
		elem.style.backgroundColor = backgroundColor0;
		elem.style.zIndex = "1";		
		stop = false;
	}, false);
...
// baby piano
function csMove6() {
	var elem = document.getElementById("csAnimation6");
	var xpos = randomX(); // x coordinate of circle
	var ypos = randomY(); // y coordinate of circle
	elem.style.left = xpos;
	elem.style.top = ypos;
	...
	// when mouse hovers over circle, it expands and stops
	elem.addEventListener("mouseover", function( event ) {   
		document.getElementById("cs-folder6").src = "resources/images/home/folder-open.png";
		elem.style.backgroundColor = backgroundColor1;
		elem.style.zIndex = "2";
		if (xpos > window.innerWidth / 2) {
			elem.children[2].style.left = tooltipRight;
