...
class Dyson extends THREE.Group {
    constructor(parent, mobile, envMap, x, y, z, scale) {
        ...
        let mobile_accent_material = new THREE.MeshBasicMaterial({
            color: settings.accent_color
        });

        let mobile_barrel_material = new THREE.MeshBasicMaterial({
            color: settings.barrel_color
        });

        let mobile_handle_material = new THREE.MeshBasicMaterial({
            color: settings.handle_color
        });

        let mobile_filter_material = new THREE.MeshBasicMaterial({
        ...
        loader.load(MODEL, obj => {
            ...
            if (mobile) {
                ...
                obj.children[2].material = mobile_filter_material;
                obj.children[3].material = mobile_barrel_material;
                obj.children[4].material = mobile_handle_material;
            } else {
    ...
    blow() {
        this.state.blow = !this.state.blow;
    }
    ...
    update(timeStamp) {
        ...
        if (this.barrel && this.state.blow) {
            this.barrel.rotateY(-Math.PI / 16);
        }
